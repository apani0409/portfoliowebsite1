...
function ProfileLink({ theme } : {theme : any}, ref : any) {
  ...
  return(
    ...
    className='flex gap-10
      ...
      <a className='flex items-center' download="Alessandro Pani Resume" href={resume} aria-label='resume' target='_blank'>
      ...
      <a className='flex items-center' aria-label='email' href='mailto: alessandro.pani1010@gmail.com' target='_blank'>
